public class Taxes {
    ...
    public final double InfrastructureLevy = 150000;
    public final double Stampduty = 35000;
    public final double Formfees= 20000;
    public final double Exciseduty= 200000;
    public final double Apsfess = 300000;
    public final double Dpsfess = 700000;
    ...
    public void calculateAmbulanceTaxes() {
        ...
        double il = (age > 10) ? 0.15 * cif : InfrastructureLevy;
        double totalTax = Stampduty + Formfees + Exciseduty + il + Dpsfess;
    ...
    public void calculateEstateTaxes() {
        ...
        double totalTax = id + vat + wht + il + Stampduty + Formfees+ Exciseduty+ Apsfess + seatingTax + weightTax + engineTax;
        printTotalTaxes(totalTax);
    }
    ...
    public void calculateSedanTaxes() {
        ...
        double totalTax = id + vat + wht + il + Stampduty+ Formfees + Exciseduty + Dpsfess+ weightTax + engineTax;
        printTotalTaxes(totalTax);
    }
    ...
    public void calculateSuvTaxes() {
        ...
        double totalTax = id + vat + wht + il + Stampduty + Formfees + Exciseduty + Apsfess+ seatingTax;
        printTotalTaxes(totalTax);
    }
    ...
    public void calculateTrailerTaxes() {
        ...
        double totalTax = id + vat + wht + il + Stampduty + Formfees + Exciseduty+ Apsfess + weightTax + engineTax;
        printTotalTaxes(totalTax);
    }
    ...
    public void calculateStandardVehicleTaxes() {
        ...
        double vat = 0.18 * cif;
        double wht = 0.06 * cif;
        double totalTax = id + vat + wht + InfrastructureLevy+ Stampduty + Formfees+ Exciseduty+ Apsfess;
        printTotalTaxes(totalTax);
    }
    ...
    public double calculateILBasedOnAge() {
        ...
        else return InfrastructureLevy;
    }
